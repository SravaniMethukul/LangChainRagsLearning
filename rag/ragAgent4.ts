...
const loader = new DocxLoader("P:/VScode/LangchainRagLearningDocs/nike-growth-story.docx")
...
const result = await agent.invoke({
    ...
    messages: [{ role: "user", content: "which town nike has grown into world famous footwear?" }]
})
console.log(result)
